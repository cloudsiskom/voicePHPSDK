...
class ConversationAIController extends BaseController
{
    ...
    /**
     * @param Models\CreateIntentRequest $body
     *
    ...
    public function createIntent(Models\CreateIntentRequest $body): void
    {
        ...
        if ($response->code == 403) {
            throw $this->createExceptionFromJson(
                '\\VoiceApiCallLib\\Exceptions\\CreateIntentException',
                'Forbidden',
                $_httpRequest,
                $_httpResponse
            );
    ...
    /**
     * @param Models\IntentQueryRequest $body
     *
     * @return Models\IntentQuery Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function intentQuery(Models\IntentQueryRequest $body): Models\IntentQuery
    {
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'IntentQuery');
    }

    /**
     * @return Models\IntentList Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function intentList(): Models\IntentList
    {
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'IntentList');
    }

    /**
     * @param Models\IntentEditRequest $body
     *
     * @return Models\IntentEdit Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function intentEdit(Models\IntentEditRequest $body): Models\IntentEdit
    {
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'IntentEdit');
    }

    /**
     * @return Models\AIName Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function aIName(): Models\AIName
    {
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'AIName');
    }

    /**
     * @param Models\IntentDeleteRequest $body
     *
     * @return Models\IntentDelete Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function intentDelete(Models\IntentDeleteRequest $body): Models\IntentDelete
    {
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'IntentDelete');
    }
}
