...
class DIDController extends BaseController
{
    ...
    /**
     * @return Models\DIDList Response from the API call
     *
    ...
    public function dIDList(): Models\DIDList
    {
        ...
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'DIDList');
    }

    /**
     * @param Models\DIDBuyRequest $body
     *
    ...
    public function dIDBuy(Models\DIDBuyRequest $body): void
    {
        ...
        if ($response->code == 404) {
            throw $this->createExceptionFromJson(
                '\\VoiceApiCallLib\\Exceptions\\DIDBuyException',
                'Not Found',
                $_httpRequest,
                $_httpResponse
            );
    ...
    /**
     * @return Models\DIDListAll Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function dIDListAll(): Models\DIDListAll
    {
        ...
        //handle errors defined at the API level
        $this->validateResponse($_httpResponse, $_httpRequest);
        return ApiHelper::mapClass($_httpRequest, $_httpResponse, $response->body, 'DIDListAll');
    }
}
